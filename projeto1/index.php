...
<div class="box">
    ...
    <button type="button" class="btn btn-primary" name="cres">Ordem Crescente</button>
    <button type="button" class="btn btn-primary" name="decres">Ordem Decrescente</button>
    ...
    require_once "ListaInterface.php";
    ...
    //Listar no index p/ incluir links


    $lista = new Lista();


    echo $lista->imprimir($clientes);
